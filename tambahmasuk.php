 ...
 ?>
  <div class="content-wrapper">
    ...
    <section class="content">
      <?php
      if (isset($_POST) && isset($_POST['submit_masuk'])) :
        if(!tambahmasuk($con, $_POST)) :
        ?>
            ...
            <form class="form-horizontal" method="POST" action="">  
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="pengirim" name="pengirim" class="form-control" placeholder="Pengirim" required>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="col-sm-2">
                    <input type="submit" name="submit_masuk" class="btn btn-primary" value="submit">
                  </div>
                </div>
              </div>
            </form>
