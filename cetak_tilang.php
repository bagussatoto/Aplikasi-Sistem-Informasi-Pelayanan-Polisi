...
include "tglindo.php"; 
$id_tilang=$_GET['id'];
            $data=mysqli_query($con, "SELECT * FROM tbl_tilang WHERE id_tilang='$id_tilang'");
...
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$data[id_tilang]"; ?>/198/TRANTIB/309.07/VIII/2019</p></td>
</tr> 
</table>
...
<td width="65%">: <?php echo "$data[no_registrasi]";?></td>
</tr>
