...
include "tglindo.php"; 
$id_dumas=$_GET['id'];
            $data=mysqli_query($con, "SELECT * FROM tbl_dumas WHERE id_dumas='$id_dumas'");
...
<table width=100%>
<tr>
    <td align="center"><h3 style='margin-bottom:-5px' align=center>SURAT LAPORAN DUMAS </h3></td>
</tr> 
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$d[id_skck]"; ?>/198/TRANTIB/309.07/VIII/2019</p></td>
</tr> 
</table>
