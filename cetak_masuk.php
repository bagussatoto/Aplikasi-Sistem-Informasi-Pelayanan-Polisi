...
include "tglindo.php"; 
$id_masuk=$_GET['id'];
            $data=mysqli_query($con, "SELECT * FROM tbl_masuk WHERE id_masuk='$id_masuk'");
...
<tr>
    <td align="center"><p>Nomor : 00<?php echo "$data[id_masuk]"; ?>/198/TRANTIB/309.07/VIII/2019</p></td>
</tr> 
</table>
